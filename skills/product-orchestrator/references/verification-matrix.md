...
producto, una API de un sistema de diseño o un cambio de framework está terminado.
...
| Sistema de diseño | Validación que exige su mantenedor (para Comsatel DS, `comsatel-design-system`): contrato de API, pruebas afectadas, documentación y publicación solo si se autorizó | Cambiaría una API pública sin versión o sin evidencia de consumidores |
...
Siguiente responsable: [usuario, equipo consumidor o mantenedor del sistema de diseño]
```
